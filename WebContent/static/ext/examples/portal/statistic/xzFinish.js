//已选址未及时进场
Ext.define('Forestry.app.statistic.xzFinish', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'xzFinishList-grid',
	region : 'center',
	initComponent : function() {
		...
		Ext.define('ModelList', {
			...
			fields : [ {
				name : 'id',
				type : 'int'
			}, 'areaMgr', 'area','stationName','xzName',
		...
		var store = me.createStore({
			modelName : 'ModelList',
			proxyUrl : appBaseUri + '/sys/statistic/getXZFinishNotIn',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			...
			items : [ {
				...
				handler : function(btn, eventObj) {
					var searchParams = {
							dateStr : Ext.getCmp('query-xzFinish-dateStr').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-xzFinish-dateStr').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
