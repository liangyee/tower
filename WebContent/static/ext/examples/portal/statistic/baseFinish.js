//基础完工未及时装塔
Ext.define('Forestry.app.statistic.baseFinish', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'baseFinishList-grid',
	region : 'center',
	initComponent : function() {
		...
		var store = me.createStore({
			modelName : 'ModelList',
			proxyUrl : appBaseUri + '/sys/statistic/getInFinishNotWG',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			...
			items : [ {
				...
				handler : function(btn, eventObj) {
					var searchParams = {
							dateStr : Ext.getCmp('query-baseFinish-dateStr').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-baseFinish-dateStr').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
