//引电方案未上报
Ext.define('Forestry.app.statistic.ydNotDesign', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'ydNotDesignList-grid',
	region : 'center',
	initComponent : function() {
		...
		Ext.define('ModelList', {
			...
			fields : [ {
				name : 'id',
				type : 'int'
			}, 'areaMgr', 'area','stationName','ydUnit',
		...
		var store = me.createStore({
			modelName : 'ModelList',
			proxyUrl : appBaseUri + '/sys/statistic/getNoYdProgram',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			...
			items : [ {
				...
				handler : function(btn, eventObj) {
					var searchParams = {
							dateStr : Ext.getCmp('query-ydNotDesign-dateStr').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-ydNotDesign-dateStr').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
