//指标统计
Ext.define('Forestry.app.statistic.ShareStationPanel', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'shareStationStatList-grid',
	region : 'center',
	initComponent : function() {
		...
		var store = me.createStore({
			modelName : 'ModelList',
			proxyUrl : appBaseUri + '/sys/statistic/getIndexForShareStation',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			id: 'shareStationPanelTT',
			items : [ {
				xtype : 'combobox',
				fieldLabel : '工程批次',
				id : 'query-shareStationStat-projectBatchNo',
				name : 'projectBatchNo',
				...
				handler : function(btn, eventObj) {
					var searchParams = {
						projectBatchNo : Ext.getCmp('query-shareStationStat-projectBatchNo').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-shareStationStat-projectBatchNo').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
