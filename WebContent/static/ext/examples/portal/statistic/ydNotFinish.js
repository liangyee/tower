//引电未完工
Ext.define('Forestry.app.statistic.ydNotFinish', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'ydNotFinishList-grid',
	region : 'center',
	initComponent : function() {
		...
		var store = me.createStore({
			modelName : 'ModelList',
			proxyUrl : appBaseUri + '/sys/statistic/getNoYdFinish',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			...
			items : [ {
				...
				handler : function(btn, eventObj) {
					var searchParams = {
							dateStr : Ext.getCmp('query-ydNotFinish-dateStr').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-ydNotFinish-dateStr').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
