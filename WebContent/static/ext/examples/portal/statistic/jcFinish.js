//已进场未及时完工
Ext.define('Forestry.app.statistic.jcFinish', {
	extend : 'Ext.ux.custom.GlobalGridPanel',
	id : 'jcFinishList-grid',
	region : 'center',
		...
		var ttoolbar = Ext.create('Ext.toolbar.Toolbar', {
			...
			items : [ {
				...
				handler : function(btn, eventObj) {
					var searchParams = {
							dateStr : Ext.getCmp('query-jcFinish-dateStr').getValue()
					};
				...
				maxWidth : 60,
				handler : function(btn, eventObj) {
					Ext.getCmp('query-jcFinish-dateStr').setValue(null);
					store.currentPage = 1;
				}
			}]
		});
